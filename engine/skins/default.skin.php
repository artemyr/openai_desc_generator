					...
					<div class="sidebar-category sidebar-category-visible">
						<div class="category-content no-padding">
							<ul class="navigation navigation-main navigation-accordion">
								...
								<li><a href="/artpjs/openai/game_desc_parser/openai_parser.php" class="legitRipple"><i class="fa fa-globe"></i> <span>Генератор описаний OpenAi</span></a></li>
...
$skin_footer = <<<HTML
					<div class="footer text-muted text-size-small">
						DataLife Engine&reg;  Copyright 2004-{$year} &copy; <a href="" target="_blank">SoftNews Media Group</a> All rights reserved.
					</div>
				</div>
			</div>
		</div>
...
<!--MAIN area-->
	...
	<div class="text-muted text-size-small text-center">DataLife Engine&reg;  Copyright 2004-{$year}<br>&copy; <a href="" target="_blank">SoftNews Media Group</a> All rights reserved.</div>
